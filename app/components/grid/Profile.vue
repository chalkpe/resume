<template lang="pug">
  .content
    h2 Profile
    p 새로운 것들에 늘 가슴이 두근거리는 작은 개발자입니다. 달콤한 간식을 먹으며 느긋하게 코딩하는 그 순간이 제일 행복해요!
  ...
  export default {
    data: () => ({
      contacts: [
        ...
        {
          text: 'chalkpe@gmail.com',
          icon: 'envelope-o',
          href: 'mailto:chalkpe@gmail.com'
        },

        {
          text: '(+82) 10-9169-4579',
          icon: 'phone',
          href: 'tel:821091694579'
        },
...

        {
          text: '경기도 고양시 일산동구',
          icon: 'home',
          href: 'https://goo.gl/maps/R6VFT7ZjQfq'
        },

        {
          text: 'Saturday, 17 June 2000',
          icon: 'birthday-cake',
          href: '#'
        }
      ]
